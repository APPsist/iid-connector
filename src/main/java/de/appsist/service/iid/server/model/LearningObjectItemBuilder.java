...
public class LearningObjectItemBuilder extends ServiceItemBuilder<LearningObjectItemBuilder>{
	...
	/**
     * Flags media to be external. Optional, defaults to <code>false</code>.
     * 
     * @return Builder instance.
     */
    public LearningObjectItemBuilder isExternal()
    {
        json.putBoolean("external", true);
        return this;
    }
     ...
     * @return Builder instance.
     */
    public LearningObjectItemBuilder setMimeType(String mimetype)
    {
        json.putString("mimeType", mimetype);
        return this;
    }
     ...
     *             Not all required information is available.
     */
