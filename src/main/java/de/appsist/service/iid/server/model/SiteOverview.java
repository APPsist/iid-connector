...
public class SiteOverview {
	...
	public static class Station {
		 ...
		 * @param action Action to perform when station is selected. May be <code>null</code>.
		 * @param learningAction Action to perform when the learning symbol clicked. May be <code>null</code>.
		 */
		public Station(String station, Level level, ContentBody content, Action action, Action learningAction) {
			json = new JsonObject();
		...
		/**
		 * Returns the action to perform when the station is selected.
		 * @return Action to perform when selected. May be <code>null</code>.
		 */
