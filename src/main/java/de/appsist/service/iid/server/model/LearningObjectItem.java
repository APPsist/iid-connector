...
public class LearningObjectItem extends ServiceItem {
    ...
    /**
     * Checks if the learning object is external.
     * 
     * @return <code>true</code> if we have external content, otherwise <code>false</code>.
     */
    public boolean isExternal()
    {
        return json.getBoolean("external", false);
    }

    /**
     * Returns the mime-type of external content, this is necessary for our Unity apps
     * 
     * @return URL to retrieve image file from.
     */
